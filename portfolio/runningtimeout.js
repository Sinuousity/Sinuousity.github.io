export class RunningTimeout
{
	...
	Interrupt(emitCompletionAction = false) { this.Complete(emitCompletionAction); }

	Complete(emitCompletionAction = true)
	{
		this.timer = 0.0;
		this.ticking = false;
		window.clearInterval(this.tickIntervalId);
		this.tickIntervalId = -1;
		if (emitCompletionAction) this.completionAction();
	}
}